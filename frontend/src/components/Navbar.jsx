...
const Navbar = () => {
  ...
  return (
    <nav className='flex justify-between items-center px-2 sm:px-10 p-3 sticky top-0 z-10 bg-white'>
      ...
      <div className='flex items-center gap-2'>
        ...
        <div className='border px-2 py-1.5 bg-slate-200 rounded-md'>
      ...
      <div className={`absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all ${visible ? 'w-full' : 'w-0'}`}>
        <div className='flex flex-col text-gray-600'>
          ...
          <NavLink onClick={() => setVisible(false)} className='py-2 pl-6 border' to='/cinemas'>Cinemas</NavLink>
